...
import org.g4studio.core.mvc.xstruts.util.ModuleException;
...
public class ExceptionHandler {
	 ...
	 * </p>
	 * <p>
	 * To use this, in your <code>struts-config.xml</code> specify the exception
	 * handler like this:
	 * 
	 * <pre>
	 *   &lt;exception
	 ...
	 * </p>
	 * <p>
	 * You would want to use this when your normal ExceptionHandler path is a
	 * Tiles definition or otherwise unsuitable for use in an
	 ...
	 * specified using the "path" attribute in the &lt;exception&gt; element.
	 * </p>
	 * 
	 * @since Struts 1.3
	 */
	...
	/**
	 * <p>
	 * The name of a configuration property which indicates that Struts should
	 * do nothing if the response has already been committed. This suppresses
	 * the default behavior, which is to use an "include" rather than a
	 * "forward" in this case in hopes of providing some meaningful information
	 * to the browser.
	 * </p>
	 * <p>
	 * To use this, in your <code>struts-config.xml</code> specify the exception
	 ...
	 * </p>
	 * <p>
	 * You only need to use this if you do not want error information displayed
	 * in the browser when Struts intercepts an exception after the response has
	 * been committed.
	 * </p>
	 * 
	 * @since Struts 1.3
	...
	private static MessageResources messages = MessageResources
			.getMessageResources("org.g4studio.core.mvc.xstruts.action.LocalStrings");
	...
	/**
	 * <p>
	 * Return a path to which an include should be attempted in the case when
	 * the response was committed before the <code>ExceptionHandler</code> was
	 * invoked.
	 * </p>
	 * <p>
	 * If the <code>ExceptionConfig</code> has the property
	 * <code>INCLUDE_PATH</code> defined, then the value of that property will
	 * be returned. Otherwise, the ActionForward path is returned.
	 * </p>
	 * 
	 * @param config
	...
	/**
	 * <p>
	 * Default implementation for handling an <code>ActionMessage</code>
