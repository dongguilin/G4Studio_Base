...
public class FieldChecks implements Serializable {
	 ...
	 * @return true if valid, false otherwise.
	 */
	public static Object validateShortLocale(Object bean, ValidatorAction va, Field field, ActionMessages errors,
			Validator validator, HttpServletRequest request) {
		Object result = null;
		String value = null;
	 ...
	 * @return true if valid, false otherwise.
	 */
	public static Object validateFloatLocale(Object bean, ValidatorAction va, Field field, ActionMessages errors,
			Validator validator, HttpServletRequest request) {
		Object result = null;
		String value = null;
	 ...
	 * @return true if valid, false otherwise.
	 */
	public static Object validateDoubleLocale(Object bean, ValidatorAction va, Field field, ActionMessages errors,
			Validator validator, HttpServletRequest request) {
		Object result = null;
		String value = null;
	 ...
	 * <code>false</code> to control whether fragments are allowed - default is
	 * <code>false</code> (i.e. fragments ARE allowed).</li>
	 * 
	 * <li>Variable <code>allowallschemes</code> can be set to <code>true</code>
	 * or <code>false</code> to control if all schemes are allowed - default is
	 * <code>false</code> (i.e. all schemes are NOT allowed).</li>
	 * 
	 * <li>Variable <code>schemes</code> can be set to a comma delimited list of
	 * valid schemes. This value is ignored if <code>allowallschemes</code> is
	 * set to <code>true</code>. Default schemes allowed are "http", "https" and
	 * "ftp" if this variable is not specified.</li>
	 * 
	 * </ul>
	 * 
	 * @param bean
