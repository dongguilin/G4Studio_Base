 ...
 * JavaBeans style properties. Methods are provided for all simple types as well
 * as object types.
 * <p/>
 * Examples:
 * <p/>
...
public class ComplexBeanProbe extends BaseProbe {
	...
	protected Object getProperty(Object object, String name) {
		try {
			...
			if (object == null) {
				throw new ProbeException("Could not get property '" + name + "' from null reference.  Cause: "
						+ t.toString(), t);
			} else {
