...
/**
 * Convenient super class for iBATIS SqlMapClient data access objects. Requires
 * a SqlMapClient to be set, providing a SqlMapClientTemplate based on it to
 * subclasses.
 * 
 * <p>
 ...
 * SqlMapClientTemplate configuration for all your DAOs, for example a custom
