...
/**
 * <p>
 * An ActionContext represents a view of a commons-chain <code>Context</code>
...
public interface ActionContext extends Context {
	...
	/**
	 * <p>
	 * Return a <code>Map</code> of Application scoped values.
	 * </p>
	 * 
	 * <p>
	 * This is implemented in analogy with the Application scope in the Servlet
	 * API, but it seems reasonable to expect that any Struts implementation
	 * will have an equivalent concept.
	 * </p>
	 * 
	 * <p>
	 * The ultimate meaning of "application scope" is an implementation detail
	...
	/**
	 * <p>
	 * Return a <code>Map</code> of Session scoped values. A session is
	 * understood as a sequence of requests made by the same user.
	 * </p>
	 * 
	 * <p>
	 * This is implemented in analogy with the Session scope in the Servlet API,
	 * but it seems reasonable to expect that any Struts implementation will
	 * have an equivalent concept.
	 * </p>
	 * 
	 * <p>
	 * The ultimate meaning of "session scope" is an implementation detail left
	 * unspecified by Struts.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Return a <code>Map</code> of request scoped values. A request is
	 * understood as the fundamental motivation for any particular instance of
	 * an <code>ActionContext</code>.
	 * </p>
	 * 
	 * <p>
	 * This is implemented in analogy with the Request Context in the Servlet
	 * API, but it seems reasonable to expect that any Struts implementation
	 * will have an equivalent concept.
	 * </p>
	 * 
	 * <p>
	 * The ultimate meaning of "request scope" is an implementation detail left
	 * unspecified by Struts.
	 * </p>
	 * 
	 ...
	 * 
	 * @param scopeName
	 *            A token identifying a scope, including but not limited to
	 *            <code>APPLICATION_SCOPE</code>, <code>SESSION_SCOPE</code>,
	...
	/**
	 * <p>
	 * Return a <code>Map</code> of parameters submitted by the user as part of
	 * this request. The keys to this map will be request parameter names (of
	 * type <code>String</code>), and the values will be <code>String[]</code>.
	 * </p>
	 * 
	 * <p>
	 * This is implemented in analogy with the Request parameters of the Servlet
	 * API, but it seems reasonable to expect that any Struts implementation
	 * will have an equivalent concept.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Set the ActionForm instance which will carry any data submitted as part
	 * of this request.
	 * </p>
	 * 
	 * @param form
	...
	/**
	 * <p>
	 * Get the ActionForm instance which will carry any data submitted as part
	 * of this request.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Set the include path which should be processed as part of processing this
	 * request.
	 * </p>
	 * 
	 * @param include
	...
	/**
	 * <p>
	 * Get the include path which should be processed as part of processing this
	 * request.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Is the ActionForm for this context valid? This method <em>does
	 ...
	 * validation for other processes' benefit.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Retrieve an exception which may have been caught by some code using this
	 * ActionContext, usually by an exception handler.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Append the given messages keys to an internal cache, creating the cache
	...
	/**
	 * <p>
	 * Append the given errors keys to an internal cache, creating the cache if
	...
	/**
	 * <p>
	 * Retrieve error messages from an internal cache, creating an empty cache
	 * if one is not already present.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Retrieve messages from an internal cache, creating an empty cache if one
	...
	/**
	 * <p>
	 * Save the given messages to the internal cache, clearing any previous
	 ...
	 * <p>
	 * Save the given messages to the internal cache, clearing any previous
	 * messages in the cache, but only for the specified scope.
	 * </p>
	 * <p>
	 * If the parameter is null or empty, the internal cache is removed.
	 * </p>
	 ...
	 * token is missing, then the transactional token is deemed invalid.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Indicate whether a transaction token is stored in the "session" scope for
	 * this context, optionally clearing the token, so that the next check would
	 * return false.
	 * </p>
	 * 
	 * @param reset
	...
	/**
	 * <p>
	 * Clear any transactional token stored in the "session" scope for this
	 * context, so that the next check would return false.
	 * </p>
	 */
	void resetToken();
	 ...
	 * 
	 * @param cancelled
	 *            On true, set the cancel event state to true. On false, set the
	 *            cancel event state to false.
	 * @see ActionContextBase.CANCEL_KEY
	 */
	...
	/**
	 * <p>
	 * Set the user's currently selected <code>Locale</code>.
	 * </p>
	 * 
	 * @param locale
