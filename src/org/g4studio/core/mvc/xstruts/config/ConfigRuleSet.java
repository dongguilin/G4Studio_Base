 ...
 * </p>
 * 
 * @version $Rev: 421119 $ $Date: 2005-08-16 15:53:27 -0400 (Tue, 16 Aug 2005) $
 * @since Struts 1.1
 */
public class ConfigRuleSet extends RuleSetBase {
	 ...
	 * <code>org.g4studio.core.mvc.xstruts.config.ModuleConfig</code> is pushed
	...
	public void addRuleInstances(Digester digester) {
		...
		digester.addSetNext("struts-config/action-mappings/action", "addActionConfig",
				"org.g4studio.core.mvc.xstruts.config.ActionConfig");
		...
		digester.addObjectCreate("struts-config/action-mappings/action/exception",
				"org.g4studio.core.mvc.xstruts.config.ExceptionConfig", "className");
		...
		digester.addSetNext("struts-config/action-mappings/action/exception", "addExceptionConfig",
				"org.g4studio.core.mvc.xstruts.config.ExceptionConfig");
		...
		digester.addSetNext("struts-config/form-beans/form-bean", "addFormBeanConfig",
				"org.g4studio.core.mvc.xstruts.config.FormBeanConfig");

		digester.addObjectCreate("struts-config/form-beans/form-bean/form-property",
				"org.g4studio.core.mvc.xstruts.config.FormPropertyConfig", "className");
		...
		digester.addSetNext("struts-config/form-beans/form-bean/form-property", "addFormPropertyConfig",
				"org.g4studio.core.mvc.xstruts.config.FormPropertyConfig");
		...
		digester.addObjectCreate("struts-config/message-resources",
				"org.g4studio.core.mvc.xstruts.config.MessageResourcesConfig", "className");
		...
		digester.addSetNext("struts-config/message-resources", "addMessageResourcesConfig",
				"org.g4studio.core.mvc.xstruts.config.MessageResourcesConfig");

		digester.addRule("struts-config/message-resources/set-property", new BaseConfigSetPropertyRule());

		digester.addObjectCreate("struts-config/plug-in", "org.g4studio.core.mvc.xstruts.config.PlugInConfig");
		digester.addSetProperties("struts-config/plug-in");
		digester.addSetNext("struts-config/plug-in", "addPlugInConfig",
				"org.g4studio.core.mvc.xstruts.config.PlugInConfig");
 ...
 * element being processed has a "key" attribute, then the value will be used to
 * call <code>setProperty(key,value)</code> on the object on top of the stack,
 * which will be assumed to be of type <code>ActionConfig</code>. Otherwise, the
 * standard <code>SetPropertyRule</code> behavior is invoked, and the value will
 * be used to set a bean property on the object on top of the Digester stack. In
 * that case, the element being processed is assumed to have attributes
 * "property" and "value".
 * </p>
 */
 ...
 * the stack, which must be a
 * <code>org.g4studio.core.mvc.xstruts.config.ModuleConfig</code>.
 * </p>
 */
 ...
 * be a <code>org.g4studio.core.mvc.xstruts.config.ModuleConfig</code>.
 * </p>
 */
