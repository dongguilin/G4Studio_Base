...
import org.g4studio.core.net.ProtocolCommandSupport;
import org.g4studio.core.net.SocketClient;
...
public class NNTP extends SocketClient {
	...
	private void __getReply() throws IOException {
		...
		if (_commandSupport_.getListenerCount() > 0)
			_commandSupport_.fireReplyReceived(_replyCode, _replyString + SocketClient.NETASCII_EOL);
	...
	protected void _connectAction_() throws IOException {
		...
		_reader_ = new BufferedReader(new InputStreamReader(_input_, __DEFAULT_ENCODING));
