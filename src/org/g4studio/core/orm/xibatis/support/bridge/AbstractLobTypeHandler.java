...
import org.g4studio.core.orm.xibatis.sqlmap.engine.type.BaseTypeHandler;
import org.g4studio.core.orm.xibatis.support.SqlMapClientFactoryBean;
...
public abstract class AbstractLobTypeHandler extends BaseTypeHandler {
	 ...
	 * LobCreators. Return DataSourceUtils.#CONNECTION_SYNCHRONIZATION_ORDER -
	 * 100 to execute LobCreator cleanup before JDBC Connection cleanup, if any.
	 * 
	...
	/**
	 * This implementation delegates to setParameterInternal, passing in a
	 * transaction-synchronized LobCreator for the LobHandler of this type.
	 * 
	...
	/**
	 * This implementation delegates to the getResult version that takes a
	 * column index.
	 * 
	...
	/**
	 * This implementation delegates to getResultInternal, passing in the
	...
	/**
	 * This implementation always throws a SQLException: retrieving LOBs from a
	 ...
	 *             if thrown by streaming methods
	 */
	protected abstract Object getResultInternal(ResultSet rs, int index, LobHandler lobHandler) throws SQLException,
			IOException;

	/**
	 * Callback for resource cleanup at the end of a Spring transaction. Invokes
