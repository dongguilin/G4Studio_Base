...
/**
 * <p>
 * An <strong>ActionForm</strong> is a JavaBean optionally associated with one
 * or more <code>ActionMappings</code>. Such a bean will have had its properties
 * initialized from the corresponding request parameters before the
 * corresponding <code>Action.execute</code> method is called.
 * </p>
 * 
 * <p>
 ...
 * <code>validate</code> method will be called, which gives the bean a chance to
 ...
 * corresponding <code>Action.execute</code> method should be called.
 * </p>
 * 
 * <p>
 * This class must be subclassed in order to be instantiated. Subclasses should
 * provide property getter and setter methods for all of the bean properties
 * they wish to expose, plus override any of the public or protected methods for
 ...
 * use the introspection API upon which ActionForms rely.
 * </p>
 * 
 * @version $Rev: 421119 $ $Date: 2005-11-12 08:14:24 -0500 (Sat, 12 Nov 2005) $
 */
public abstract class ActionForm implements Serializable {
	 ...
	 * <code>ActionServletWrapper</code>.
	 * </p>
	 * 
	...
	/**
	 * <p>>
	 * Can be used to reset all bean properties to their default state. This
	 * method is called before the properties are repopulated by the controller.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * This method is <strong>not</strong> the appropriate place to initialize
	 * form value for an "update" type page (this should be done in a setup
	 * Action). You mainly need to worry about setting checkbox values to false;
	 ...
	 * encapsulates any validation errors that have been found. If no errors are
	 ...
	 * request, and return an <code>ActionErrors</code> object that encapsulates
