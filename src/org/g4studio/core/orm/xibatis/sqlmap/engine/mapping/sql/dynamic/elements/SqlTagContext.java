...
public class SqlTagContext {
	...
	/**
	 * examine the value of the top RemoveFirstPrependMarker object on the
	 * stack.
	 * 
	...
	/**
	 * pop the first RemoveFirstPrependMarker once the recursion is on it's way
	 * out of the recursion loop and return it's internal value.
	 * 
	 * @param tag
	 */
	...
	/**
	 * push a new RemoveFirstPrependMarker object with the specified internal
	 * state
	 * 
	 * @param tag
	 */
	...
	/**
	 * iterate context is stored here for nested dynamic tags in the body of the
	 * iterate tag
	 * 
	...
	/**
	 * iterate context is removed here from the stack when iterate tag is
...
/**
 * 
 * This inner class i used strictly to house whether the removeFirstPrepend has
 * been used in a particular nested situation.
 * 
