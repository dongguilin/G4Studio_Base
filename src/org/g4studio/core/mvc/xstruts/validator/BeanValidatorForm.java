...
/**
 * <p>
 * Struts <i>validator</i> <code>ActionForm</code> backed by either a
 * <code>DynaBean</code> or POJO JavaBean.
 * </p>
 * 
 * <p>
 ...
 * can't be changed to extend <ActionForm</code>.
 * </p>
 * 
 * <p>
 * This form is based on the standard struts <code>ValidatorForm</code> for use
 * with the <i>Validator</i> framework and validates either using the
 * <i>name</i> from the Struts <code>ActionMapping</code> or the
 * <code>ActionMapping</code>'s path depending on whether
 * <code>pathValidation</code> is <code>true</code> or <code>false</code>.
 * </p>
 * 
 * <p>
 * <b>Note</b>: WrapDynaBean is NOT serializable. If you use this class with a
 * WrapDynaBean (as described above), you should not store your form in session
 * scope.
 * </p>
 */
public class BeanValidatorForm extends ValidatorForm implements DynaBean, Serializable {
	 ...
	 * <code>ActionMapping</code>'s path.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Return the <code>DynaBean</code> that this <code>ActionForm</code> is
	 * backed by.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Return the <code>Bean</code> that this <code>ActionForm</code> is backed
	 * by.
	 * </p>
	 * 
	 * <p>
	 * If the <code>DynaBean</code> is a <code>WrapDynaBean</code> type then
	 * this method returns the 'Wrapped' POJO bean associated with it. If you
	 * require the actual <code>WrapDynaBean</code> then use the
	 * <code>getDynaBean()</code> method.
	 * </p>
	 */
