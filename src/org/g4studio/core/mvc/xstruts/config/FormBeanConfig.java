...
import org.g4studio.core.mvc.xstruts.action.DynaActionForm;
import org.g4studio.core.mvc.xstruts.action.DynaActionFormClass;
...
import org.g4studio.core.mvc.xstruts.validator.BeanValidatorForm;
...
public class FormBeanConfig extends BaseConfig {
	 ...
	 */
	protected void inheritFormProperties(FormBeanConfig config) throws ClassNotFoundException, IllegalAccessException,
	 ...
	 */
	public void inheritFrom(FormBeanConfig config) throws ClassNotFoundException, IllegalAccessException,
			InstantiationException, InvocationTargetException {
		throwIfConfigured();
