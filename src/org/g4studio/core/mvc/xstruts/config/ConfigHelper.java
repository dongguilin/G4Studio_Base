...
import org.g4studio.core.mvc.xstruts.action.*;
...
public class ConfigHelper implements ConfigHelperInterface {
	 ...
	 * ServletContext can be set by any servlet in the application. The request
	 * should be the instant request. Most of the other methods retrieve their
	 * own objects by reference to the application, request, or session
	 * attributes. Do not call other methods without setting these first! This
	 * is also called by the convenience constructor.
	 * </p>
	 * 
	 * @param application
	...
	/*
	 * <p> Retrieve and return the <code>ActionForm</code> bean associated with
