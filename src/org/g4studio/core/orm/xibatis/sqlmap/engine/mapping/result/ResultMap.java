...
import org.g4studio.core.orm.xibatis.sqlmap.engine.exchange.DataExchange;
...
import org.g4studio.core.orm.xibatis.sqlmap.engine.mapping.result.loader.ResultLoader;
...
public class ResultMap {
	...
	public void setResultMappingList(List resultMappingList) {
		if (allowRemapping) {
			this.remappableResultMappings.set((ResultMapping[]) resultMappingList
					.toArray(new ResultMapping[resultMappingList.size()]));
		} else {
