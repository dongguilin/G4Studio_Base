...
import org.g4studio.core.mvc.xstruts.util.ResponseUtils;
 ...
 * requests, with support for adding parameters at runtime. <br/>
...
public class ActionRedirect extends ActionForward {
	...
	/**
	 * <p>
	 * Construct a new instance with the specified path and initialize parameter
	 * lists.
	 * </p>
	 * 
	 * @param path
	...
	/**
	 * <p>
	 * Construct a new instance with a {@link ForwardConfig} object to copy
	 * name, path, and contextRelative values from.
	 * </p>
	 * 
	 * @param baseConfig
	 *            the {@link ForwardConfig} to copy configuration values from
	 */
	...
	/**
	 * <p>
	 * Adds the object's toString() to the list of parameters if it's not null,
	 * or an empty string with the given fieldName if it is.
	 * </p>
	 * 
	 * @param fieldName
	...
	/**
	 * <p>
	 * Adds an anchor to the path. Technically, the anchor value is just stored
	 * for later and will be added to the path in getPath(). Note that this is a
	 * considerably simpler method than the addParmaeter method because aside
	 * from encoding the value, there isn't really anything to do. Passing in
	 * null is fine because that is the value that will be checked for later to
	 * determine whether to append an anchor to the path or not.
	 * </p>
	 * 
	 * @param anchorValue
	...
	/**
	 * <p>
	 * Get the path for this object, including any parameters that may have been
	 * added at runtime.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Forms the string containing the parameters passed onto this object thru
	 * calls to addParameter().
	 * </p>
	 * 
	 * @return a string which can be appended to the URLs. The return string
	 *         includes a leading hash mark (#).
	 */
