...
import org.g4studio.core.orm.xibatis.sqlmap.engine.exchange.DataExchangeFactory;
...
import org.g4studio.core.orm.xibatis.sqlmap.engine.mapping.statement.PaginatedDataList;
...
import org.g4studio.core.orm.xibatis.sqlmap.engine.transaction.TransactionState;
import org.g4studio.core.orm.xibatis.sqlmap.engine.transaction.user.UserProvidedTransaction;
...
public class SqlMapExecutorDelegate {
	 ...
	 *            - the parameter object
	 * @param resultObject
	 *            - the result object (if not supplied or null, a new object
	 *            will be created)
	 * @return - the result of the query
	 * @throws SQLException
	 *             - if the query fails
