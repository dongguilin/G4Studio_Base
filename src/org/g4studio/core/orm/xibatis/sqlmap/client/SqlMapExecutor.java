...
/**
 * This interface declares all methods involved with executing statements and
 * batches for an SQL Map.
 * 
 * @see SqlMapSession
 * @see SqlMapClient
 */
public interface SqlMapExecutor {
	 ...
	 *         list for each sub-batch executed. A sub-batch is created by
	 *         adding a statement to the batch that does not equal the prior
	 *         statement.
	 * @throws SQLException
