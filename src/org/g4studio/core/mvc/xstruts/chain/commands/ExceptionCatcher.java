...
/**
 * <p>
 * Intercept any exception thrown by a subsequent <code>Command</code> in this
 * processing chain, and fire the configured exception handler chain after
 * storing the exception that has occurred into the <code>Context</code>.
 * </p>
 * 
...
public class ExceptionCatcher extends ActionCommandBase implements Filter {
	...
	/**
	 * <p>
	 * Return the name of the <code>Catalog</code> in which to perform lookups,
	 * or <code>null</code> for the default <code>Catalog</code>.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Set the name of the <code>Catalog</code> in which to perform lookups, or
	 * <code>null</code> for the default <code>Catalog</code>.
	 * </p>
	 * 
	 * @param catalogName
	 *            The new catalog name or <code>null</code>
	 */
	...
	/**
	 * <p>
	 * Clear any existing stored exception and pass the <code>context</code> on
	 * to the remainder of the current chain.
	 * </p>
	 * 
	 * @param actionCtx
	...
	/**
	 * <p>
	 * If an exception was thrown by a subsequent <code>Command</code>, pass it
	 * on to the specified exception handling chain. Otherwise, do nothing.
	 * </p>
	 * 
	 * @param context
