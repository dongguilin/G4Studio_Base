...
/**
 * <p>
 * Struts <i>Lazy</i> <code>ActionForm</code> which <i>wraps</i> a
 * <code>LazyDynaBean</code>.
 * </p>
 * 
 * <p>
 * There isn't really that much to this implementation as most of the
 * <i>lazy</i> behaviour is in <code>LazyDynaBean</code> and <i>wrapping</i> the
 * <code>LazyDynaBean<code> is handled in the parent
 ...
 * <code>LazyDynaBean<code> in the <code>get(name, index)</code> method.
 * </p>
 * 
 * <p>
 ...
 * <ul>
 * 
 * <li><b><i>lazy</i> property addition</b> - properties which do not exist are
 ...
 * <code>List</code> or <code>Array</code> for <i>indexed</i> properties, if it
 * doesn't exist.</li>
 * <li><b><i>lazy</i> Map creation</b> - automatic creation of a
 * <code>Map</code> for <i>mapped</i> properties, if it doesn't exist.</li>
 * 
 * </ul>
 * 
 * <p>
 * Using this <i>lazy</i> <code>ActionForm</code> means that you don't have to
 * define the ActionForm's properties in the <code>struts-config.xml</code>.
 ...
 * form properties you expect to be there rather than blindly populating all the
 * properties into the business tier.
 * </p>
 * 
 * <p>
 ...
 * <i>mapped</i> or <i>indexed</i> properties. For example, if you want to use a
 * different <code>Map<code> implementation from the default
 * <code>HashMap</code> or an array for indexed properties, rather than the
 * default <code>List</code> type:
 * </p>
 * 
 * <pre>
 * <code>
 *   &lt;form-bean name="myForm" type="org.g4studio.core.mvc.xstruts.validator.LazyValidatorForm"&gt;
 ...
 * 
 * <p>
 * Another reason for defining <i>indexed</i> properties in the
 ...
 * zero-length indexed property (array or List) being instantiated, avoiding an
 * issue with validator in that circumstance.
 * </p>
 * 
 * <p>
 * This implementation validates using the ActionForm <i>name</i>. If you
 * require a version that validates according to the <i>path</i> then it can be
 * easily created in the following manner:
 * </p>
 * 
 * <pre>
 * <code>
 ...
 * <code>ActionForms</code> in a <code>BeanValidatorForm</code>. For example:
 * </p>
 * 
 * <pre>
 * <code>
...
public class LazyValidatorForm extends BeanValidatorForm {
	 ...
	 * 
	 * <p>
	 * If the "indexed" property is a <code>List</code> type then any missing
	 * values are populated with a bean (created in the
	 * <code>newIndexedBean(name)</code> method - in this implementation this is
	 * a <code>LazyDynaBean</code> type.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Creates new <code>DynaBean</code> instances to populate an 'indexed'
	 * property of beans - defaults to <code>LazyDynaBean</code> type.
	 * </p>
	 * 
	 * <p>
