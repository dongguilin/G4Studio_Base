 ...
 * 
 * <p>
 * where <code>parameter</code> contains three possible methods and one default
 * method if nothing matches (such as the user pressing the enter key).
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * The <em>default</em> key is purely optional. If this is not specified and no
 * parameters match the list of method keys, <code>null</code> is returned which
 * means the <code>unspecified</code> method will be invoked.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * To implement this <i>dispatch</i> behaviour in an <code>Action</code>, class
...
public class EventActionDispatcher extends ActionDispatcher {
	 ...
	 * <code>EventActionDispatcher</code> should provide an
	 * <code>unspecified</code> method if they wish to provide behavior
	...
	protected String getMethodName(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		while (st.hasMoreTokens()) {
			...
			if ((request.getParameter(methodKey) != null) || (request.getParameter(methodKey + ".x") != null)) {
				return methodName;
			}
		}
