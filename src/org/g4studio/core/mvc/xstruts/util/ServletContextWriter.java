 ...
 * <code>javax.servlet.ServletContext</code> to output its results. Output will
 * be buffered until a newline character is output, <code>flush()</code> is
 * called, or until one of the <code>println()</code> methods is called. Along
 * the way, carriage return characters are skipped.
 * 
...
public class ServletContextWriter extends PrintWriter {
	 ...
	 * 
	 * @param buf
	 *            The character array from which to write
	 * @param off
	 *            The zero-relative starting offset to write
	 * @param len
