...
/**
 * <p>
 * An <strong>Action</strong> that dispatches to to one of the public methods
...
public class EventDispatchAction extends DispatchAction {
	...
	protected ActionForward unspecified(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		String message = messages.getMessage("event.parameter", mapping.getPath(), mapping.getParameter());
